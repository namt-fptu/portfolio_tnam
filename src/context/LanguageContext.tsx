...
const translations = {
  en: {
    ...
    "hero.desc": "Successfully transitioned from a ReactJS/NextJS frontend background to SAP enterprise services. Dedicated to building robust RAP unmanaged pipelines, clean CDS view models, and high-efficiency Open SQL.",
    "hero.view_projects": "View My Projects",
    "hero.academic_profile": "Academic & Tech Profile",
    "hero.profile_title": "Solid educational foundation & enterprise internship background.",
    "hero.profile_desc": "Highly adaptable multi-stack awareness enables me to easily communicate across complex frontend consumer layers and internal SAP transactional systems.",
    ...
    "exp_awards.architectural_guideline": "\"Simple, clean-code structures are always the hardest to design, but they offer the longest service life and easiest maintainability under heavy enterprise system concurrency.\"",
  ...
  vi: {
    ...
    "hero.desc": "Chuyển đổi thành công từ nền tảng frontend ReactJS/NextJS sang các dịch vụ doanh nghiệp SAP. Đam mê xây dựng các hệ thống RAP unmanaged tối ưu, thiết kế CDS view mẫu mực và viết Open SQL hiệu năng cao.",
    "hero.view_projects": "Xem các dự án",
    "hero.academic_profile": "Học vấn & Công nghệ",
    "hero.profile_title": "Nền tảng học thuật vững chắc & Kinh nghiệm thực tập doanh nghiệp.",
    "hero.profile_desc": "Khả năng am hiểu đa nền tảng (multi-stack) giúp mình dễ dàng làm việc, kết nối giữa các lớp giao diện người dùng hiện đại và hệ thống nghiệp vụ SAP phức tạp.",
    ...
    "exp_awards.architectural_guideline": "\"Một cấu trúc mã nguồn đơn giản, mộc mạc và chuẩn chỉ luôn là thứ khó thiết kế nhất, nhưng nó đem lại tuổi thọ bền vững và khả năng bảo trì tối ưu dưới tần suất tải cực lớn của doanh nghiệp.\"",
